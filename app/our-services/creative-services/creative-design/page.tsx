...
const SECTIONS = [
  {
    id: "hero",
    type: "VERTICAL",
    title: "Outsource Creative Design",
    subtitle: "Creative Design Excellence",
    desc: "Elevate your brand by leveraging our world-class creative design team, delivering a comprehensive suite of premium design solutions. We develop bespoke, strategically aligned visual assets that reflect your vision while ensuring a seamless, high-touch client experience from concept to completion.",
  ...
  // --- FIXED SECTION 2 (4 BOXES RESTORED) ---
  {
    ...
    desc: "Outsourcing creative design enhances efficiency, reduces operational burden, and delivers high-quality results through specialized expertise and proven design methodologies.",
    points: [
        { title: "We Provide an Effortless Outsourcing Experience", text: "Enjoy a frictionless engagement model designed to reduce operational complexity and deliver seamless creative design execution from concept to delivery." },
        { title: "We Strive To Deliver Optimum Service Quality", text: "Our teams adhere to enterprise-grade standards, ensuring precision, reliability, and performance across every phase of your design project." },
        ...
        { title: "A One-Stop Solution for All Your Creative Design Needs", text: "From branding to digital design, we offer a full spectrum of creative services under one roof, enabling unified management and accelerated delivery." }
    ],
  ...
  },
  {
    ...
    icon: <Share2 />,
    points: [
        { id: "01", title: "LOGO DESIGN", text: "Distinctive brand identities engineered for elite market recognition and lasting brand impact." },
        { id: "02", title: "UI/UX DESIGNS", text: "High-performance interface designs crafted for seamless, intuitive user engagement and conversion optimization." },
        { id: "03", title: "SOCIAL MEDIA DESIGNS", text: "Impactful visual content optimized for maximum visibility and audience influence across all platforms." },
        { id: "04", title: "PROMOTIONAL DESIGNS", text: "Persuasive campaign creatives designed to accelerate demand and drive conversions through compelling visuals." },
  ...
  },
  {
    ...
    title: "VALUE\nCREATIVE DESIGN",
    subtitle: "CREATIVE DESIGN",
    desc: "Select your clearance level. Enhance your brand with our premium creative design packages.",
    ...
    plans: [
      {
        ...
        price: "$300",
        period: "/project",
        desc: "An entry-level creative design package delivering refined, high-quality visual assets for early-stage brand elevation.",
      ...
      },
      {
        ...
        price: "$500",
        period: "/Projects",
        desc: "A comprehensive creative design experience crafted to ensure consistency, professionalism, and strong market positioning.",
        features: ["Creative Design", "Corporate Profile", "Business Stationery Suite", "Social Media Creative Assets", "Brand Style Guide", "Web Design (Enhanced Layout)"],
        highlight: false,
      ...
      },
      {
        ...
        price: "$1,000",
        period: "/Projects",
        desc: "A strategic creative design package designed for growth-oriented organizations requiring elevated creative standards.",
      ...
      },
      {
        ...
        price: "$2,000",
        period: "/Projects",
        desc: "An all-inclusive, enterprise-grade creative design solution engineered for high-value organizations seeking unmatched creative precision and market impact.",
  ...
  // --- PORTFOLIO SECTION (MOVED TO LAST) ---
  {
    ...
    desc: "A collection of creative design projects that elevated brands and drove engagement.",
