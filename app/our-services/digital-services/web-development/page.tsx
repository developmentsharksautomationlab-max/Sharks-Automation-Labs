...
const SECTIONS = [
  {
    ...
    subtitle: "Outsource Web Development Excellence",
    desc: "Leverage our elite web development team to architect high-performance digital platforms that strengthen your brand’s ecosystem. We deliver front-end, back-end, and full-stack solutions engineered to accelerate growth, optimize operational efficiency, and maximize ROI with enterprise-grade precision.",
  ...
  },
  {
    ...
    desc: "Our web development solutions are engineered to deliver high-performance, scalable, and visually compelling digital ecosystems. We create enterprise-grade platforms that strengthen brand authority, elevate user experience, and accelerate measurable business growth.",
    color: new THREE.Color("#FFD700"),
    shape: "DNA_EVOLVING",
    icon: <Share2 />,
    points: [
      { id: "01", title: "Front-End Development", text: "Pixel-perfect, responsive interfaces built for premium user experiences across all devices and environments." },
      { id: "02", title: "Back-End Development", text: "Robust, scalable infrastructure designed to handle high-volume traffic and complex data processing." },
      { id: "03", title: "Full-Stack Development", text: "End-to-end development services delivering seamless, enterprise-grade digital solutions." },
      { id: "04", title: "Custom Web Applications", text: "Custom web applications tailored to your unique business needs, delivering tailored functionality and enhanced operational efficiency." },
      { id: "05", title: "E-Commerce Development", text: "High-performance, secure e-commerce solutions engineered to optimize online sales and customer engagement." },
      { id: "06", title: "CMS Development", text: "Enterprise-level content management systems enabling streamlined operations and effortless scalability." }
    ]
  },
  {
    id: "pricing",
    ...
    desc: "Select your clearance level. Elevate your digital presence with our premium web development packages.",
    ...
    plans: [
      {
        ...
        price: "$300",
        period: "/project",
        desc: "An entry-level web development package delivering refined, high-performance digital solutions for early-stage business growth",
        features: ["Front-End Development (Responsive Pages)", "Standard Web Layout", "Basic CMS Integration", "Social Media Landing Pages", ""],
        highlight: true,
      ...
      },
      {
        ...
        price: "$500",
        period: "/Projects",
        desc: "A comprehensive web development package crafted to ensure consistency, professionalism, and strong market positioning.",
        features: ["Front-End Development (Enhanced UI/UX)", "Back-End Integration (Database + APIs)", "Corporate Website (Up to 5 Pages)", "CMS Implementation & Management", "Standard E-Commerce Setup"],
        highlight: false,
      ...
      },
      {
        ...
        price: "$1,000",
        period: "/Projects",
        desc: "A strategic web development package designed for growth-oriented organizations requiring elevated creative standards.",
        features: ["Advanced Front-End & Back-End Development (Full-Stack)", "Custom Web Applications (Tailored to Business Needs)", "Responsive Corporate Website (Up to 10 Pages)", "CMS Development with Admin Panel", "E-Commerce Platform (Secure & Scalable)", "API Integrations & Automation Features"],
        highlight: false,
      ...
      },
      {
        ...
        price: "2,000",
        period: "Projects",
        desc: "An enterprise-grade, end-to-end web development solution engineered for high-value organizations seeking market-leading digital experiences and performance.",
        features: ["Complete Full-Stack Development (Front-End + Back-End + DevOps)", "Custom Web Applications & Complex Workflows", "Enterprise E-Commerce Platform with Multi-Channel Integration", "CMS & Advanced Content Governance", "UX/UI Design Optimization with Animations", "Dedicated Technical Consultant & Support", "Performance Monitoring & Security Hardening"],
        highlight: false,
      ...
      >
        <div ref={contentRef} className="relative z-10 max-w-4xl w-full flex flex-col items-center justify-center text-center pointer-events-auto">
          <div className="relative z-10 px-8 py-12">
            <h2 className="text-2xl sm:text-3xl md:text-3xl lg:text-5xl font-bold text-white tracking-tighter leading-[1.1] mb-6">{data.title}</h2>
