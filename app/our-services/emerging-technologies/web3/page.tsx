...
const SECTIONS = [
  {
    ...
    subtitle: "Web 3.0 Excellence",
    desc: "Leverage our elite Web 3.0 development team to build decentralized applications that drive innovation and business growth. We deliver cutting-edge Web 3.0 solutions engineered with advanced technologies to maximize decentralization, enhance user control, and create next-generation digital experiences.",
  ...
  // --- FIXED SECTION 2 (4 BOXES RESTORED) ---
  {
    ...
    title: "WHY CHOOSE\nWEB 3.0 DEVELOPMENT?",
    subtitle: "WEB 3.0",
    desc: "Web 3.0 development creates decentralized, user-controlled applications that transform digital experiences and drive innovation.",
    points: [
        { title: "We Provide Cutting-Edge Web 3.0 Solutions", text: "Enjoy innovative Web 3.0 applications designed to enhance decentralization, user control, and operational efficiency through blockchain technology." },
        { title: "We Strive To Deliver Optimum Service Quality", text: "Our teams adhere to enterprise-grade standards, ensuring precision, reliability, and performance across every phase of your Web 3.0 project." },
        ...
        { title: "A One-Stop Solution for All Your Web 3.0 Needs", text: "From DApps to DeFi, we offer a full spectrum of Web 3.0 services under one roof, enabling unified management and accelerated delivery." }
    ],
  ...
  },
  {
    ...
    type: "HORIZONTAL",
    title: "WEB 3.0\nSOLUTIONS",
    subtitle: "WEB 3.0 SERVICES",
    desc: "Our Web 3.0 solutions are engineered to deliver high-performance, secure, and decentralized applications. We create enterprise-grade platforms that strengthen business operations, enhance user control, and accelerate measurable growth.",
    color: new THREE.Color("#FFD700"), 
    shape: "DNA_EVOLVING",
    icon: <Share2 />,
    points: [
        { id: "01", title: "DApp Development", text: "Decentralized applications built with Web3.js, Ethers.js, and modern blockchain technologies." },
        { id: "02", title: "DeFi Platform Development", text: "Decentralized finance platforms including lending, borrowing, and trading protocols." },
        { id: "03", title: "Web3 Wallet Integration", text: "Seamless integration with MetaMask, WalletConnect, and other Web3 wallets." },
        { id: "04", title: "Smart Contract Development", text: "Secure and audited smart contracts for various blockchain networks and use cases." },
        { id: "05", title: "Web3 Consulting", text: "Strategic Web3 consulting to identify opportunities and develop implementation roadmaps." }
    ]
  },
  {
    id: "pricing",
    ...
    title: "VALUE\nWEB 3.0 DEVELOPMENT",
    subtitle: "WEB 3.0",
    desc: "Select your clearance level. Elevate your business with our premium Web 3.0 development packages.",
  ...
  // --- PORTFOLIO SECTION (MOVED TO LAST) ---
  {
    ...
    desc: "A collection of Web 3.0 projects that transformed digital experiences.",
