...
const SECTIONS = [
  {
    ...
    subtitle: "Digital Agency Excellence",
    desc: "Leverage our comprehensive digital agency solutions to build powerful client management and service delivery platforms. We deliver end-to-end agency systems engineered with advanced technologies to maximize client satisfaction, streamline operations, and accelerate business growth.",
  ...
  // --- FIXED SECTION 2 (4 BOXES RESTORED) ---
  {
    ...
    desc: "Digital agency solutions transform agency operations by creating seamless client management and service delivery experiences that drive client satisfaction, enhance productivity, and maximize revenue.",
    points: [
        { title: "We Provide Complete Digital Agency Solutions", text: "Enjoy comprehensive agency platforms designed to streamline operations and deliver measurable business results through optimized client management." },
        { title: "We Strive To Deliver Optimum Service Quality", text: "Our teams adhere to enterprise-grade standards, ensuring precision, reliability, and performance across every phase of your agency project." },
        ...
        { title: "A One-Stop Solution for All Your Agency Needs", text: "From client portals to project management, we offer a full spectrum of agency services under one roof, enabling unified management and accelerated growth." }
    ],
  ...
  },
  {
    ...
    subtitle: "DIGITAL AGENCY",
    desc: "Our digital agency solutions are engineered to deliver high-performance, scalable, and client-focused agency platforms. We create enterprise-grade systems that strengthen agency operations, enhance client experiences, and accelerate measurable business growth.",
    color: new THREE.Color("#FFD700"), 
    shape: "DNA_EVOLVING",
    icon: <Share2 />,
    points: [
        { id: "01", title: "Client Portal Development", text: "Custom client portals for project tracking, deliverables, and communication management." },
        { id: "02", title: "Project Management System", text: "Complete project management solutions for tracking tasks, timelines, and team collaboration." },
        { id: "03", title: "Agency Website Development", text: "Professional agency websites showcasing services, portfolio, and team expertise." },
        { id: "04", title: "CRM Integration", text: "Seamless CRM integration for managing client relationships and sales pipelines." },
        { id: "05", title: "Agency Marketing", text: "Strategic agency marketing including SEO, content marketing, social media, and lead generation campaigns." }
    ]
  },
  {
    id: "pricing",
    ...
    title: "VALUE\nDIGITAL AGENCY",
    subtitle: "DIGITAL AGENCY",
    desc: "Select your clearance level. Elevate your agency with our premium digital agency packages.",
  ...
  // --- PORTFOLIO SECTION (MOVED TO LAST) ---
  {
    ...
    desc: "A collection of successful digital agency projects that improved operations.",
