...
const SECTIONS = [
  {
    ...
    subtitle: "Law Firm Excellence",
    desc: "Leverage our comprehensive law firm solutions to build secure, compliant, and client-focused legal platforms. We deliver end-to-end legal systems engineered with advanced technologies to enhance client relationships, streamline case management, and improve legal outcomes.",
  ...
  // --- FIXED SECTION 2 (4 BOXES RESTORED) ---
  {
    ...
    title: "WHY CHOOSE\nLAW FIRM SOLUTIONS?",
    subtitle: "LAW FIRM",
    desc: "Law firm solutions transform legal practices by creating secure, compliant, and client-focused digital platforms that enhance case management and client service.",
    points: [
        { title: "We Provide Secure Law Firm Solutions", text: "Enjoy secure legal platforms designed to meet regulatory requirements and deliver measurable improvements in case management." },
        { title: "We Strive To Deliver Optimum Service Quality", text: "Our teams adhere to enterprise-grade standards, ensuring precision, reliability, and compliance across every phase of your law firm project." },
        ...
        { title: "A One-Stop Solution for All Your Law Firm Needs", text: "From case management to client portals, we offer a full spectrum of legal services under one roof, enabling unified management and accelerated delivery." }
    ],
  ...
  },
  {
    ...
    desc: "Our law firm solutions are engineered to deliver secure, compliant, and client-focused legal platforms. We create enterprise-grade systems that strengthen legal operations, enhance client experiences, and improve case management efficiency.",
    color: new THREE.Color("#FFD700"), 
    shape: "DNA_EVOLVING",
    icon: <Share2 />,
    points: [
        { id: "01", title: "Case Management System", text: "Comprehensive case management platforms for tracking cases, documents, and deadlines." },
        { id: "02", title: "Client Portal Development", text: "Secure client portals for case updates, document sharing, and communication." },
        { id: "03", title: "Legal Document Management", text: "Secure document management systems for storing and organizing legal documents." },
        { id: "04", title: "Billing & Time Tracking", text: "Integrated billing and time tracking systems for accurate invoicing and productivity monitoring." },
        { id: "05", title: "Law Firm Marketing", text: "Strategic law firm marketing including SEO, content marketing, and client acquisition campaigns." }
    ]
  },
  {
    id: "pricing",
    ...
    title: "VALUE\nLAW FIRM SOLUTIONS",
    subtitle: "LAW FIRM",
    desc: "Select your clearance level. Elevate your law firm with our premium law firm packages.",
  ...
  // --- PORTFOLIO SECTION (MOVED TO LAST) ---
  {
    ...
    desc: "A collection of successful law firm projects that improved case management.",
