...
const SECTIONS = [
  {
    ...
    subtitle: "Vehicle Rental Excellence",
    desc: "Leverage our comprehensive vehicle rental solutions to build powerful booking and fleet management platforms. We deliver end-to-end rental systems engineered with advanced technologies to maximize bookings, enhance customer experience, and accelerate business growth.",
  ...
  // --- FIXED SECTION 2 (4 BOXES RESTORED) ---
  {
    ...
    desc: "Vehicle rental solutions transform rental businesses by creating seamless booking and fleet management experiences that drive rentals, enhance customer satisfaction, and maximize revenue.",
    points: [
        { title: "We Provide Complete Vehicle Rental Solutions", text: "Enjoy comprehensive rental platforms designed to drive bookings and deliver measurable business results through optimized rental experiences." },
        { title: "We Strive To Deliver Optimum Service Quality", text: "Our teams adhere to enterprise-grade standards, ensuring precision, reliability, and performance across every phase of your rental project." },
        ...
        { title: "A One-Stop Solution for All Your Vehicle Rental Needs", text: "From online booking to fleet management, we offer a full spectrum of rental services under one roof, enabling unified management and accelerated growth." }
    ],
  ...
  },
  {
    ...
    subtitle: "VEHICLE RENTAL SERVICES",
    desc: "Our vehicle rental solutions are engineered to deliver high-performance, scalable, and conversion-optimized rental platforms. We create enterprise-grade systems that strengthen brand authority, elevate customer experiences, and accelerate measurable revenue growth.",
    color: new THREE.Color("#FFD700"), 
    shape: "DNA_EVOLVING",
    icon: <Share2 />,
    points: [
        { id: "01", title: "Online Booking System", text: "Custom online booking platforms with vehicle selection, availability checking, and payment integration." },
        { id: "02", title: "Fleet Management System", text: "Complete fleet management solutions for tracking vehicles, maintenance, and availability." },
        { id: "03", title: "Customer Portal", text: "Customer portals for booking history, rental management, and account information." },
        { id: "04", title: "Mobile App Development", text: "Native mobile apps for customers to browse, book, and manage rentals on the go." },
        { id: "05", title: "Vehicle Rental Marketing", text: "Strategic vehicle rental marketing including SEO, PPC, social media, and email campaigns to drive bookings and customer retention." }
    ]
  },
  {
    id: "pricing",
    ...
    title: "VALUE\nVEHICLE RENTAL",
    subtitle: "VEHICLE RENTAL",
    desc: "Select your clearance level. Elevate your vehicle rental business with our premium rental packages.",
  ...
  // --- PORTFOLIO SECTION (MOVED TO LAST) ---
  {
    ...
    desc: "A collection of successful vehicle rental projects that drove bookings and growth.",
