...
const SECTIONS = [
  {
    id: "hero",
    type: "VERTICAL",
    title: "Outsource Designer Resources",
    subtitle: "Designer Resources Excellence",
    desc: "Leverage our elite team of professional designers to scale your creative operations. We deliver comprehensive design resources including UI/UX designers, graphic designers, and creative specialists engineered to enhance your brand, accelerate project delivery, and maximize creative output.",
  ...
  // --- FIXED SECTION 2 (4 BOXES RESTORED) ---
  {
    ...
    type: "VERTICAL",
    title: "WHY OUTSOURCE\nDESIGNER RESOURCES?",
    subtitle: "DESIGNER RESOURCES",
    desc: "Outsourcing designer resources enhances efficiency, reduces operational burden, and delivers high-quality creative work through specialized design expertise.",
    points: [
        { title: "We Provide an Effortless Outsourcing Experience", text: "Enjoy a frictionless engagement model designed to reduce operational complexity and deliver seamless design execution from concept to delivery." },
        ...
        { title: "A One-Stop Solution for All Your Design Needs", text: "From UI/UX to graphic design, we offer a full spectrum of design services under one roof, enabling unified management and accelerated delivery." }
    ],
  ...
  },
  {
    ...
    type: "HORIZONTAL",
    title: "DESIGNER\nRESOURCES",
    subtitle: "DESIGNER SERVICES",
    desc: "Our designer resources are engineered to deliver high-performance, scalable, and creative design solutions. We provide enterprise-grade design talent that strengthens brand authority, elevates visual experiences, and accelerates measurable creative output.",
    color: new THREE.Color("#FFD700"), 
    shape: "DNA_EVOLVING",
    icon: <Share2 />,
    points: [
        { id: "01", title: "UI/UX Designers", text: "Expert UI/UX designers specializing in user interface design, user experience optimization, and interactive design." },
        { id: "02", title: "Graphic Designers", text: "Professional graphic designers for branding, marketing materials, and visual communication." },
        { id: "03", title: "Web Designers", text: "Skilled web designers creating responsive, modern, and conversion-optimized website designs." },
        { id: "04", title: "Brand Designers", text: "Creative brand designers developing comprehensive brand identities and style guides." },
        { id: "05", title: "Design Support", text: "Dedicated design support including revisions, maintenance, and ongoing creative collaboration." }
    ]
  },
  {
    id: "pricing",
    ...
    title: "VALUE\nDESIGNER RESOURCES",
    subtitle: "DESIGNER RESOURCES",
    desc: "Select your clearance level. Elevate your creative operations with our premium designer resource packages.",
  ...
  // --- PORTFOLIO SECTION (MOVED TO LAST) ---
  {
    ...
    desc: "A collection of successful design projects that elevated brands.",
