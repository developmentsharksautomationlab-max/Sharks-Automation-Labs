...
const SECTIONS = [
  {
    id: "hero",
    type: "VERTICAL",
    title: "Outsource Marketing Resources",
    subtitle: "Marketing Resources Excellence",
    desc: "Leverage our elite team of professional marketers to scale your marketing operations. We deliver comprehensive marketing resources including SEO specialists, social media managers, and content creators engineered to enhance your brand visibility, accelerate campaign delivery, and maximize marketing ROI.",
  ...
  // --- FIXED SECTION 2 (4 BOXES RESTORED) ---
  {
    ...
    type: "VERTICAL",
    title: "WHY OUTSOURCE\nMARKETING RESOURCES?",
    subtitle: "MARKETING RESOURCES",
    desc: "Outsourcing marketing resources enhances efficiency, reduces operational burden, and delivers high-quality marketing work through specialized marketing expertise.",
    points: [
        { title: "We Provide an Effortless Outsourcing Experience", text: "Enjoy a frictionless engagement model designed to reduce operational complexity and deliver seamless marketing execution from strategy to results." },
        ...
        { title: "A One-Stop Solution for All Your Marketing Needs", text: "From SEO to social media, we offer a full spectrum of marketing services under one roof, enabling unified management and accelerated delivery." }
    ],
  ...
  },
  {
    ...
    desc: "Our marketing resources are engineered to deliver high-performance, scalable, and results-driven marketing solutions. We provide enterprise-grade marketing talent that strengthens brand visibility, elevates campaign performance, and accelerates measurable marketing ROI.",
    color: new THREE.Color("#FFD700"), 
    shape: "DNA_EVOLVING",
    icon: <Share2 />,
    points: [
        { id: "01", title: "SEO Specialists", text: "Expert SEO specialists specializing in search engine optimization, keyword research, and content optimization." },
        { id: "02", title: "Social Media Managers", text: "Professional social media managers for content creation, community management, and engagement strategies." },
        { id: "03", title: "Content Creators", text: "Skilled content creators producing blog posts, articles, and marketing copy that drives engagement." },
        { id: "04", title: "PPC Specialists", text: "Creative PPC specialists managing Google Ads, Facebook Ads, and performance marketing campaigns." },
        { id: "05", title: "Marketing Support", text: "Dedicated marketing support including analytics, reporting, and ongoing campaign optimization." }
    ]
  },
  {
    id: "pricing",
    ...
    title: "VALUE\nMARKETING RESOURCES",
    subtitle: "MARKETING RESOURCES",
    desc: "Select your clearance level. Elevate your marketing operations with our premium marketing resource packages.",
  ...
  // --- PORTFOLIO SECTION (MOVED TO LAST) ---
  {
    ...
    desc: "A collection of successful marketing campaigns that drove results.",
