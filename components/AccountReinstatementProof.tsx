...
// --- Account Reinstatement Proof Component ---
const AccountReinstatementProof: React.FC = () => {
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4 sm:mb-6">
              Building The Recovery of Tomorrow, Today.
            </h2>
            <p className="text-sm sm:text-base md:text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              We help businesses recover their suspended accounts!
            </p>
          </motion.div>

          {/* Statistics Grid */}
          <div ref={statsRef} className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-12 sm:mb-16">
            {/* Accounts Recovered */}
            <motion.div
          ...
          >
            ...
            <div className="relative bg-black/50 backdrop-blur-sm rounded-3xl p-6 sm:p-10 md:p-12 text-center z-20">
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4 sm:mb-6">
                Ready to See These Results for Your Account Recovery?
              </h3>
              <p className="text-sm sm:text-base md:text-xl text-gray-300 mb-6 sm:mb-8 max-w-3xl mx-auto">
                Join our systematic approach to account reinstatement and start generating consistent, measurable returns from your recovered assets.
              </p>
              <a
                href="/contact"
...
export default AccountReinstatementProof;
