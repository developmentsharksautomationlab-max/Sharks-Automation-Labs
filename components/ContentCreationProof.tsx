          ...
          >
            ...
            <div className="relative bg-black/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 md:p-12 text-center z-20">
              ...
              <div className="flex justify-center">
                <a href="/contact" className="inline-flex w-full sm:w-auto items-center justify-center bg-teal-400 px-4 py-2.5 text-xs sm:px-6 sm:py-3 sm:text-sm md:px-8 md:py-4 md:text-base font-bold uppercase tracking-wider text-white transition-colors hover:bg-white hover:text-black rounded-full cursor-pointer">
