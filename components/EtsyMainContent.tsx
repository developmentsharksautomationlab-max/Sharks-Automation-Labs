            ...
            >
              <div className="space-y-6">
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 leading-tight max-w-3xl">
                  ...
                  <span className="text-teal-600">Etsy Ecosystem</span>
                </h2>
                
                <p className="text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed max-w-3xl">
                  While traditional markets fluctuate on sentiment, Etsy's marketplace grows on fundamental consumer demand for unique, handmade products. 
                  We identify and capitalize on this permanent shift, deploying capital with surgical precision into high-margin 
                  verticals within the world's leading handmade and vintage marketplace platform.
                </p>
                
                <p className="text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed max-w-3xl">
                  Our firm provides a seamless, institutional-grade gateway into Etsy's thriving ecosystem. We handle 
                  all operations—from shop creation to global fulfillment—transforming your capital into an actively managed, 
                ...
                <div className="space-y-6">
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      <h3 className="text-lg font-bold text-white">Shop Optimization</h3>
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      <p className="text-gray-300 text-sm">AI-powered demand forecasting and inventory management</p>
                    </div>
                  </motion.div>
                </div>
                ...
                <div className="space-y-6 mt-8 sm:mt-12">
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      <p className="text-gray-300 text-sm">Access to Etsy's worldwide marketplace network</p>
                    </div>
                  </motion.div>
                </div>
              </div>
