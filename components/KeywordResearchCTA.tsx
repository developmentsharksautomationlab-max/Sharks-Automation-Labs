        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-12 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h2 className="text-4xl lg:text-6xl font-bold text-white mb-6">
              Ready to Dominate Your <span className="text-yellow-300">Keywords</span>?
            </h2>
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Stop guessing which keywords to target. Let our data-driven approach help you 
              find the high-value opportunities that will skyrocket your organic traffic and sales.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
              <div className="text-center">
                ...
                <p className="text-blue-100">Get a free keyword analysis of your current website</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-blue-100">See improvements in organic traffic within 30 days</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-blue-100">100% money-back guarantee if you don't see results</p>
              </div>
            </div>
            
            <div className="mt-8 text-blue-100">
              <p className="text-sm">
                <span className="font-semibold">Limited Time:</span> Get 50% off your first keyword research package
              </p>
