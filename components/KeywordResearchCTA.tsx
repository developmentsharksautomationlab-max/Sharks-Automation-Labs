...
// --- Keyword Research CTA Component ---
const KeywordResearchCTA: React.FC = () => {
      ...
      <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-start relative z-10">
        ...
        <div className="bg-gray-50 border border-gray-200 backdrop-blur-md text-gray-900 p-5 sm:p-6 md:p-8 rounded-2xl shadow-2xl shadow-teal-400/25">
          ...
          <p className="text-sm sm:text-base text-gray-600 mt-2 mb-6 sm:mb-8">
            Connect with us to explore how we can deliver exceptional keyword research solutions for your business.
          </p>
          ...
          <form className="space-y-4 sm:space-y-6">
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-1">Monthly SEO Budget <span className="text-red-500">*</span></label>
              <div className="relative">
                <select className="w-full appearance-none bg-gray-50 border border-gray-300 rounded-md p-3 text-gray-900 focus:ring-1 focus:ring-teal-500 focus:border-teal-500 transition-colors">
                  <option className="bg-white text-gray-900">Your Monthly SEO Budget</option>
                  <option className="bg-white text-gray-900">Under $2,000</option>
                  <option className="bg-white text-gray-900">$2,000 - $10,000</option>
                  <option className="bg-white text-gray-900">$10,000 - $50,000</option>
                  <option className="bg-white text-gray-900">$50,000+</option>
                </select>
          ...
          <div className="space-y-12 sm:space-y-16">
            <div className="flex items-start gap-6 group">
              ...
              <div>
                ...
                <p className="text-base sm:text-lg text-gray-600 mt-2 max-w-sm group-hover:text-gray-700 transition-colors duration-300">We're across 5 continents, explore our office nearest to you.</p>
                <a 
                  href="/about"
                  className="inline-flex items-center justify-center bg-teal-400 text-black font-bold py-2.5 px-6 sm:py-3 sm:px-8 text-sm sm:text-base rounded-full mt-6 hover:bg-black hover:text-white transition-all duration-300 hover:shadow-2xl hover:shadow-teal-400/25 hover:-translate-y-1 cursor-pointer"
                >
                  Learn more
                </a>
              </div>
            ...
            <div className="flex items-start gap-6 group">
              ...
              <div>
                ...
                <p className="text-base sm:text-lg text-gray-600 mt-2 max-w-sm group-hover:text-gray-700 transition-colors duration-300">Our capability and competencies are backed by diverse Global leadership.</p>
                <a 
                  href="/about"
                  className="inline-flex items-center justify-center bg-teal-400 text-black font-bold py-2.5 px-6 sm:py-3 sm:px-8 text-sm sm:text-base rounded-full mt-6 hover:bg-black hover:text-white transition-all duration-300 hover:shadow-2xl hover:shadow-teal-400/25 hover:-translate-y-1 cursor-pointer"
                >
...
export default KeywordResearchCTA;