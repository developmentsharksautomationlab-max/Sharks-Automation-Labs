    ...
    <section className="relative bg-black py-8 px-8 overflow-hidden">
      ...
      <div className="relative z-10 flex h-full items-center justify-center">
        <div className="text-center text-white p-8">
          ...
          >
            Your Partner in{' '}
            <span className="text-teal-400">E-Commerce</span>,{' '}
            Forged in{' '}
            <span className="text-teal-400">High Finance</span>
          </motion.h1>
          ...
          >
            We transformed the rigorous investment strategies of Fortune 500 clients into a{' '}
            <span className="text-teal-400 font-semibold">done-for-you service</span>, so you can achieve{' '}
            <span className="text-teal-400 font-semibold">financial freedom</span> without the 9-to-5 grind.
          </motion.p>
