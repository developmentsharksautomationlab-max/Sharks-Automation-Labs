        ...
        <div className="bg-gray-50 border border-gray-200 backdrop-blur-md text-gray-900 p-8 rounded-2xl shadow-2xl shadow-teal-400/25">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button 
              ...
              className="w-full bg-teal-400 text-black font-bold py-4 rounded-md hover:bg-black hover:text-white transition-all duration-300 hover:shadow-2xl hover:shadow-teal-400/25 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
            >
