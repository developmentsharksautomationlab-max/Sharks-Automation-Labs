                ...
                <div className="space-y-6">
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      <h3 className="text-lg font-bold text-white group-hover:text-teal-100 transition-colors duration-500">Product Discovery</h3>
                      <p className="text-gray-300 text-sm group-hover:text-gray-200 transition-colors duration-500">Advanced research and analysis for winning product identification</p>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      <h3 className="text-lg font-bold text-white group-hover:text-teal-100 transition-colors duration-500">Market Analysis</h3>
                      <p className="text-gray-300 text-sm group-hover:text-gray-200 transition-colors duration-500">Comprehensive market intelligence that drives strategic advantage</p>
                    </div>
                  </motion.div>
                </div>
                ...
                <div className="space-y-6 mt-12">
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      <h3 className="text-lg font-bold text-white group-hover:text-teal-100 transition-colors duration-500">Supplier Sourcing</h3>
                      <p className="text-gray-300 text-sm group-hover:text-gray-200 transition-colors duration-500">Strategic supplier partnerships that maximize profit margins</p>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      <h3 className="text-lg font-bold text-white group-hover:text-teal-100 transition-colors duration-500">E-commerce Growth</h3>
                      <p className="text-gray-300 text-sm group-hover:text-gray-200 transition-colors duration-500">Accelerating growth through comprehensive product optimization</p>
                    </div>
                  </motion.div>
                </div>
              </div>
