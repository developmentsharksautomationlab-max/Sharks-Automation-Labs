...
// --- Product Hunting Main Content Component ---
            ...
            >
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base sm:text-lg md:text-xl text-gray-600 leading-relaxed max-w-3xl">
                  We are your trusted product hunting partner, delivering comprehensive market research 
                  that drives exceptional e-commerce success. Our expertise spans from advanced trend analysis 
                  to strategic supplier sourcing, ensuring your brand achieves peak marketplace performance. 
                  We specialize in identifying winning products and competitive advantages 
            ...
            >
              <div className="grid grid-cols-2 gap-3 sm:gap-4 md:gap-6">
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <motion.div 
                    style={{ y: firstCardY }}
                    className="bg-black border border-teal-400/30 p-5 sm:p-6 rounded-2xl relative overflow-hidden group hover:border-teal-400/60 transition-all duration-500"
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      <h3 className="text-base sm:text-lg font-bold text-white group-hover:text-teal-100 transition-colors duration-500">Product Discovery</h3>
                      <p className="text-gray-300 text-xs sm:text-sm group-hover:text-gray-200 transition-colors duration-500">Advanced research and analysis for winning product identification</p>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      <h3 className="text-base sm:text-lg font-bold text-white group-hover:text-teal-100 transition-colors duration-500">Market Analysis</h3>
                      <p className="text-gray-300 text-xs sm:text-sm group-hover:text-gray-200 transition-colors duration-500">Comprehensive market intelligence that drives strategic advantage</p>
                    </div>
                  </motion.div>
                </div>
                ...
                <div className="space-y-4 sm:space-y-6 mt-8 sm:mt-12">
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      <h3 className="text-base sm:text-lg font-bold text-white group-hover:text-teal-100 transition-colors duration-500">Supplier Sourcing</h3>
                      <p className="text-gray-300 text-xs sm:text-sm group-hover:text-gray-200 transition-colors duration-500">Strategic supplier partnerships that maximize profit margins</p>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      <h3 className="text-base sm:text-lg font-bold text-white group-hover:text-teal-100 transition-colors duration-500">E-commerce Growth</h3>
                      <p className="text-gray-300 text-xs sm:text-sm group-hover:text-gray-200 transition-colors duration-500">Accelerating growth through comprehensive product optimization</p>
                    </div>
                  </motion.div>
                </div>
              </div>
