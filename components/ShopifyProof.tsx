...
// --- Shopify Proof Component ---
const ShopifyProof: React.FC = () => {
  const proofData = [
    {
      id: 1,
      imageUrl: "/images/shopify-proof/sopify-sale1.png",
      alt: "Shopify Performance Metrics 1"
    },
    {
      id: 2,
      imageUrl: "/images/shopify-proof/shopify-sale2.png",
      alt: "Shopify Performance Metrics 2"
    },
    {
      id: 3,
      imageUrl: "/images/shopify-proof/shopify-sale3.png",
      alt: "Shopify Performance Metrics 3"
    }
  ];
          ...
          >
            ...
            <div className="relative z-10">
              <h3 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Ready to See These Results for Your Shopify Business?
              </h3>
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Join our systematic approach to Shopify automation and start generating consistent, measurable returns.
              </p>
              <a
                href="/contact"
