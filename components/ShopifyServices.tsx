...
// --- Shopify Services Component ---
const ShopifyServices: React.FC = () => {
  const servicesData = [
    {
      id: 1,
      title: "Systematic Store Optimization",
      description: "Advanced analytics and A/B testing frameworks that systematically optimize conversion rates, customer acquisition costs, and lifetime value across your Shopify portfolio."
    },
    {
      id: 2,
      title: "Institutional-Grade Fulfillment Operations",
      description: "Automated inventory management, order processing, and global fulfillment networks that ensure seamless operations at scale with enterprise-level reliability."
    }
  ];
