      ...
      <div className="relative z-10 flex h-full items-center justify-between flex-col-reverse gap-10 lg:flex-row lg:gap-6">
          ...
          >
            <div className="space-y-6">
              ...
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-300 leading-relaxed max-w-3xl font-normal text-justify lg:text-left hyphens-auto lg:hyphens-none">
                Transform your capital into a systematically managed, cash-flow generative TikTok enterprise. 
                We deploy sophisticated automation technologies to scale your social commerce operations while you focus on strategic growth.
              </p>
        ...
        >
          <div className="relative">
            <Image
              src="/images/companies/processed/tiktok.png"
              alt="TikTok Logo"
              width={400}
              height={400}
