...
// --- TikTok Services Component ---
const TikTokServices: React.FC = () => {
  const servicesData = [
    {
      id: 1,
      title: "Systematic Content Optimization",
      description: "AI-driven content creation and optimization frameworks that systematically maximize engagement rates, viral potential, and conversion metrics across your TikTok portfolio."
    },
    {
      id: 2,
      title: "Institutional-Grade Influencer Operations",
      description: "Automated influencer discovery, partnership management, and performance tracking that ensures seamless operations at scale with enterprise-level reliability."
    }
  ];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4 sm:mb-6">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-cyan-500">Social Commerce Domination</span>
            </h2>
            <p className="text-sm sm:text-base md:text-xl text-gray-400 max-w-4xl mx-auto leading-relaxed">
              Our battle-tested automation frameworks have been refined through managing millions in TikTok capital. 
              We deploy systematic approaches that transform your investment into a scalable, cash-flow generative social commerce enterprise.
            </p>
          </motion.div>
