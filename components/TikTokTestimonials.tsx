...
// --- TikTok Testimonials Component ---
const TikTokTestimonials: React.FC = () => {
  const testimonials = [
    {
      name: "Alex Thompson",
      role: "Social Media Portfolio Manager",
      company: "Digital Influence Capital",
      date: "Jan 18, 2025",
      content: "Shark Retail's systematic approach to TikTok automation delivered exceptional results. Within 90 days, our portfolio generated $35K in monthly recurring revenue. Their proprietary content optimization algorithms and strategic influencer partnerships transformed our TikTok operations into a cash-flow generative asset.",
      metrics: [
        { label: "Monthly Revenue", value: "$35K" },
        { label: "Time to Profit", value: "90 Days" }
      ]
    },
    {
      name: "Maria Santos",
      role: "Influence Investment Director",
      company: "Social Commerce Ventures",
      date: "Dec 15, 2024",
      content: "The institutional-grade automation frameworks deployed by Shark Retail exceeded all expectations. Our TikTok portfolio achieved 450% growth through their systematic approach to viral content creation and strategic positioning. Their proprietary systems consistently outperform market benchmarks.",
      metrics: [
        { label: "Portfolio Growth", value: "450%" },
        { label: "Market Outperformance", value: "280%" }
      ]
    },
    {
      name: "David Kim",
      ...
      <div className="container mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
            Our partners have achieved extraordinary returns through systematic TikTok automation. 
